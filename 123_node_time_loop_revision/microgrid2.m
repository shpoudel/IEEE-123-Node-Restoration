function [Aineq, bineq, mg_insP1, mg_insQ1, mg_insv1,mg_insP2, mg_insQ2, mg_insv2]=microgrid2(Aineq, bineq,mg2,power,loop_node1,yp1,f,path1,path2,nNodes,node)
    ...
    insert=1;      
    [P1eq,P11eq,indp1,indnode]=formeq(mg2,power,insert,G,loop_node1);
    [Q1eq,Q11eq,indq1,indnode]=formeq_reactive(mg2,power,insert,G,loop_node1);
    ...
    vec2P=indnode+nNodes*11+(size(loop_node1,2)-1)*9;
    vec2Q=indnode+nNodes*12+(size(loop_node1,2)-1)*10;
    ...
    from=nNodes*12+(size(loop_node1,2)-1)*9+1;
    to=nNodes*12+(size(loop_node1,2)-1)*10;
    s=size(f,1);
    step=1;
   [Aineq, bineq]=product_of_variables(Aineq,bineq, vec1P,vec2P,from ,to,s,step);
    %Product of variables for Q
    from=nNodes*13+(size(loop_node1,2)-1)*10+1;
    to=nNodes*13+(size(loop_node1,2)-1)*11;
    step=1;
   [Aineq, bineq]=product_of_variables(Aineq,bineq, vec1Q,vec2Q,from ,to,s,step);
    ...
    zi=zeros(nNodes,560);
    mg_insP1=[P11eq zi z2 z2 z z2 z2 z           P1eq z2 z z2 z2 z         z2 z2 z z2 z2 z           z2 z2 z z2 z2 z         z2 z2 z z2 z2 z];
    mg_insQ1=[Q11eq zi z2 z2 z z2 z2 z           z2 Q1eq z z2 z2 z         z2 z2 z z2 z2 z           z2 z2 z z2 z2 z         z2 z2 z z2 z2 z];
    mg_insv1=[z zi z z1 z z1 z z2 z2 z      Vp1 z1 Vq1 z1 Volt1 z2 z2 z    z z1 z z1 z z2 z2 z       z z1 z z1 z z2 z2 z     z z1 z z1 z z2 z2 z]; 
    ...
    %Later these values are used to calculate the voltage at the nodes with
    insert=1;
    [P2eq,P22eq,ind_p1,ind_node]=formeq_path_two(mg2,power,insert,G,loop_node1);
    [Q2eq,Q22eq,ind_q1,ind_node]=formeq_path_two_reactive(mg2,power,insert,G,loop_node1);
    for i=1:size(loop_node1,2)-1
    ...
    vec2P=ind_node+nNodes*14+(size(loop_node1,2)-1)*11;
    from=nNodes*15+11*(size(loop_node1,2)-1)+1;
    to=nNodes*15+(size(loop_node1,2)-1)*12;
    step=1;
    [Aineq, bineq]=product_of_variables(Aineq,bineq, vec1P,vec2P,from ,to,s,step); 
    %For Reactive power basedd on path #2
    vec2Q=ind_node+nNodes*15+(size(loop_node1,2)-1)*12;
    from=nNodes*16+(size(loop_node1,2)-1)*12+1;
    to=nNodes*16+(size(loop_node1,2)-1)*13;
    step=1;
    [Aineq, bineq]=product_of_variables(Aineq,bineq, vec1Q,vec2Q,from ,to,s,step); 
    %Voltage values according to path 1 needs to be calculated as follows,
    Volt2=zeros(125,125);
    ...
    z=zeros(nNodes,nNodes);    
    zi=zeros(nNodes,560);
    mg_insP2=[P22eq zi z2 z2 z z2 z2 z          z2 z2 z P2eq z2 z           z2 z2 z z2 z2 z           z2 z2 z z2 z2 z         z2 z2 z z2 z2 z];
    mg_insQ2=[Q22eq zi z2 z2 z z2 z2 z          z2 z2 z z2 Q2eq z           z2 z2 z z2 z2 z           z2 z2 z z2 z2 z         z2 z2 z z2 z2 z];
    mg_insv2=[z zi z z1 z z1 z z2 z2 z       z2 z2 z Vp2 z1 Vq2 z1 Volt2    z z1 z z1 z z2 z2 z       z z1 z z1 z z2 z2 z     z z1 z z1 z z2 z2 z]; 
   end
